            ...
            <div class="col-md-8">
                ...
                {!! Form::open(['route' => 'contact', 'class' => 'form-horizontal', 'autocomplete' => 'off']) !!}
                    ...
                    <div class="form-group text-left">
                        {!! Form::textarea('message', null, ['class' => 'form-control', 'cols' => '30', 'rows' => '3', 'placeholder' => 'Mensagem', 'style' => 'resize: none; height: 121px']) !!}
                    </div>
                    <div class="form-group">
                        {!! Captcha::display() !!}
                    </div>
                    <div class="form-group text-left submit-div">
